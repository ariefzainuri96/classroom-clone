...
//     mutationFn: async () => {
//       const data = (await axiosInstance.post<JobsDetailResponse>('/jobs', JSON.stringify(job))).data;
...
//     mutationFn: async () => {
//       const data = (await axiosInstance.put<JobsDetailResponse>(`jobs/${job?._id}`, JSON.stringify(job))).data;
